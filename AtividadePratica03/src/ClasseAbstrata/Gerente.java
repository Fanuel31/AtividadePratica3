...
public class Gerente extends Funcionario implements Trabalhavel{
    ...
    public float calcularSalario() {
        return (getValorHora() * getHorasTrabalhadas()) + 2500;
    }
    ...
    public String trabalhar() {
        return"O gerente " + getNome() + " está coordenamdo equipe " + getEquipe();
    }
    @Override
    public String relatarProgresso() {
        return getNome() + " disse que a equipe " + getEquipe() + " está finalizando o projeto";
    }
