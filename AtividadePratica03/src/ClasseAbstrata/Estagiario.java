...
public class Estagiario extends Funcionario implements Trabalhavel{
    ...
    public String trabalhar() {
        return"O estagiário " + getNome() + " esta sendo supervisionado por " + getSupervisor();
    }

    @Override
    public String relatarProgresso() {
        return"De acordo com o " + getSupervisor() + " o estagiário " + getNome() + " esta melhorando cada vez mais ";
    }
